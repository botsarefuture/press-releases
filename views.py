# views.py
from flask import Blueprint, session, redirect, url_for, render_template, request, abort, send_from_directory, Response
...
def sitemap():
    ...
    for release in press_releases:
        urls.append({'loc': url_for('main.release', id=release['_id'], _external=True), 'lastmod': ''})
